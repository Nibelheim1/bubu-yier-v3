...
export function makeBackground(theme,layer='far'){
  ...
  if(layer==='sky'){
    ...
    if(theme==='commute'){
      ...
      for(let i=0;i<24;i++){const x=(i*317)%1600,y=490+(i*31)%160;g.fillStyle='#e4d7a2';g.globalAlpha=.45;g.beginPath();g.arc(x,y,2.4,0,7);g.fill();}g.globalAlpha=1;
    }
  }
  return c;
}
